# TransitPulse-WMATA-KPI-Analytics
SQL-based public transit analytics system integrating ridership, incidents, and crime data into a star-schema for KPI monitoring.
